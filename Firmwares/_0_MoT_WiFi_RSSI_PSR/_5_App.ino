...
void App_receive()
{
  ...
  if(byte34){
    TX_ledblink = false;  //Configura o módulo para não piscar o LED verde quando envia pacote na serial
  }
  else{
    TX_ledblink = true;  //Configura o módulo para piscar o LED verde quando envia pacote na serial
  }//=====
