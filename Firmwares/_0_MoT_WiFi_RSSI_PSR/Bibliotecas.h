...
bool TX_ledblink; // Variável booleana para determinar se o led vermelho deve piscar na recepção
bool RX_ledblink; // Variável booleana para determinar se o led verde deve piscar na transmissão
