...
##         print(bytes(PacoteTX))
   ...
   # ============= Camada Aplicação                  
         ...
         print ('Cont = ', j,' RSSI = ', RSSId,' PSR = ', PSR, 'LED NodeMCU = ',Status_led_nodemcu,' LED Esp = ',Status_led_esp)

         # Salva no arquivo de log
         print (time.asctime(),';',j,';',RSSId,';',PSR,';', Status_led_nodemcu, ';', Status_led_esp,file=Log_dados)
